...
const RoomSet = () => {
  ...
  useEffect(() => {
    if (selectedDate) {
      ...
      axios.get(`https://lnmiit-guest-server.onrender.com/api/availability-range?startDate=${selectedDate}&endDate=${selectedDate}`)
        .then(response => {
  ...
  const handleSave = () => {
    ...
    axios.post("https://lnmiit-guest-server.onrender.com/api/store-availability", data)
      .then(response => {
